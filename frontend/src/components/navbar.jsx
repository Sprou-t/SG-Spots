...
const Navbar = () => {
  return (
    ...
    <div className="fixed scroll-m-0 top-0 font-bold w-screen flex flex-col md:flex-row space-y-2 md:space-y-0 justify-between items-center backdrop-filter backdrop-blur-lg bg-opacity-30  hover:bg-white">

      {/* Logo and Text Linking to Homepage */}
      <Link to="/" className="flex gap-2 items-center">
        <img src={logo} alt="SG SPOTS" className="h-16 rounded-lg" />
        <span className='text-white'>SG SPOTS</span>
      </Link>
